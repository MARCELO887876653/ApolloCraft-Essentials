...
public class Transactions extends TableImpl<TransactionsRecord> {
     ...
     */
    public final TableField<TransactionsRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>transactions.ts</code>.
     */
    public final TableField<TransactionsRecord, Long> TS = createField(DSL.name("ts"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>transactions.from_owner</code>.
     */
    public final TableField<TransactionsRecord, String> FROM_OWNER = createField(DSL.name("from_owner"), SQLDataType.VARCHAR(36), this, "");

    /**
     * The column <code>transactions.to_owner</code>.
     */
    public final TableField<TransactionsRecord, String> TO_OWNER = createField(DSL.name("to_owner"), SQLDataType.VARCHAR(36), this, "");

    /**
     * The column <code>transactions.currency</code>.
     */
    public final TableField<TransactionsRecord, String> CURRENCY = createField(DSL.name("currency"), SQLDataType.VARCHAR(32).nullable(false), this, "");

    /**
     * The column <code>transactions.amount</code>.
     */
    public final TableField<TransactionsRecord, BigDecimal> AMOUNT = createField(DSL.name("amount"), SQLDataType.DECIMAL(20, 4).nullable(false), this, "");

    /**
     * The column <code>transactions.type</code>.
     */
    public final TableField<TransactionsRecord, String> TYPE = createField(DSL.name("type"), SQLDataType.VARCHAR(32).nullable(false), this, "");

    /**
     * The column <code>transactions.reason</code>.
     */
    public final TableField<TransactionsRecord, String> REASON = createField(DSL.name("reason"), SQLDataType.VARCHAR(32).nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.IDX_TRANSACTIONS_CURRENCY, Indexes.IDX_TRANSACTIONS_FROM, Indexes.IDX_TRANSACTIONS_TO);
    }
