...
public final class UxmEssentialsPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getLogger().info("║    ╚═════╝ ╚═╝  ╚═╝╚═╝     ╚═╝                           ║");
        getLogger().info("║                                                          ║");
        getLogger().info("║   ApolloCraft Essentials v" + getPluginMeta().getVersion() + "                         ║");
        getLogger().info("║   ApolloCraft • baseado em uxmEssentials (UXPLIMA)      ║");
        getLogger().info("║                                                          ║");
        getLogger().info("╚══════════════════════════════════════════════════════════╝");
        ...
        getLogger().info("╔══════════════════════════════════════════════════════════╗");
        getLogger().info("║  ApolloCraft Essentials iniciado em " + loadTime + "ms!             ║");
        getLogger().info("╚══════════════════════════════════════════════════════════╝");
    }
    ...
    public void onDisable() {
        getLogger().info("Desativando ApolloCraft Essentials...");
        CloseableResources wired = this.resources;
        if (wired != null) {
        ...
        getLogger().info("ApolloCraft Essentials desativado!");
    }
}
